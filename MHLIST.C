...
char DFlatApplication[] = "Menhera List";
...
int DfpMain(int argc, char *argv[])
{
    ...
    if (cfg.ReadOnlyMode)
    		sprintf (WindowTitle, "MHLIST (viewer mode) %i.%i", ProgramModule.Ver_maj, ProgramModule.Ver_min, ProgramModule.Ver_rel+'a'-1);
    else
    		sprintf (WindowTitle, "Menhera List %i.%i", ProgramModule.Ver_maj, ProgramModule.Ver_min, ProgramModule.Ver_rel+'a'-1);
